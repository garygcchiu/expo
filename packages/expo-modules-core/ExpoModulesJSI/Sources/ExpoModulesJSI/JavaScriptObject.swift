...
//  }
  ...
  @discardableResult
  @JavaScriptActor
  public func callFunction<each T: JSRepresentable>(_ functionName: String, arguments: repeat each T) -> JavaScriptValue {
    return self.getPropertyAsFunction(functionName).call(this: self, arguments: repeat each arguments)
  }
